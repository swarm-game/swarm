...
Swarm is a game.  The goals for both playing and contributing to Swarm
are the same: to have fun, make friends, and challenge yourself to
learn more about programming and problem solving.  These goals are
incompatible with the use of generative AI.

Contributions to Swarm may **not** include any content generated by
large language models or other generative AI tools.  Contributions
which may not contain AI-generated content include—but are not
limited to—code, comments, documentation, pull request descriptions,
or issues.
