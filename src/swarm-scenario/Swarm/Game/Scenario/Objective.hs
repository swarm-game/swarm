...
data Objective phase = Objective
  { _objectiveGoal :: Markdown.Document (Syntax Raw)
...
deriving instance ToJSON (Objective Raw)
...
objectiveGoal :: Lens' (Objective phase) (Markdown.Document (Syntax Raw))
...
newtype Announcement
  = ObjectiveCompleted (Objective Raw)  -- XXX Raw?
