...
constInfo c = case c of
  ...
  Path ->
    command 2 short
      . doc "Obtain shortest path to the destination."
  ...
  Reprogram ->
    command 2 long
      . doc "Reprogram another robot with a new command."
      $ ["The other robot has to be nearby and idle."]
  Drill ->
    command 1 long
      . doc "Drill through an entity."
  ...
  Use ->
    command 2 long
      . doc "Use one entity upon another."
  ...
  Listen ->
    command 1 long
      . doc "Listen for a message from other actors."
  ...
  Waypoint ->
    command 2 Intangible
      . doc "Get the x, y coordinates of a named waypoint, by index"
  ...
  Detect ->
    command 2 Intangible
      . doc "Detect an entity within a rectangle."
  ...
  Resonate ->
    command 2 Intangible
      . doc "Count specific entities within a rectangle."
  ...
  Density ->
    command 1 Intangible
      . doc "Count all entities within a rectangle."
  ...
  Sniff ->
    command 1 short
      . doc "Determine distance to entity."
  ...
  Chirp ->
    command 1 short
      . doc "Determine direction to entity."
  ...
  Watch ->
    command 1 short
      . doc "Interrupt `wait` upon location changes."
  ...
  Surveil ->
    command 1 short
      . doc "Interrupt `wait` upon (remote) location changes."
  ...
  Scan ->
    command 1 Intangible
      . doc "Scan a nearby location for entities."
  ...
  Isempty ->
    command 0 Intangible
      . doc "Check if the current location is empty."
  ...
  Random ->
    command 1 Intangible
      . doc "Get a uniformly random integer."
  ...
  Split ->
    function 2
      . doc "Split the text into two at given position."
  ...
  CharAt ->
    function 2
      . doc "Get the character at a given index."
  ...
  ToChar ->
    function 1
      . doc "Create a singleton `text` value from the given character code."
      $ [ "That is, `chars (toChar c) == 1` and `charAt 0 (toChar c) == c`."
        ]
  AppF ->
    binaryOp "$" 0 R
      . doc "Apply the function on the left to the value on the right."
  ...
  Swap ->
    command 1 short
      . doc "Swap placed entity with one in inventory."
  ...
  Atomic ->
    command 1 Intangible
      . doc "Execute a block of commands atomically."
  ...
  Instant ->
    command 1 Intangible
      . doc "Execute a block of commands instantly."
      $ [ "Like `atomic`, but with no restriction on program size."
        ]
  Key ->
    function 1
      . doc "Create a key value from a text description."
  ...
  InstallKeyHandler ->
    command 2 Intangible
      . doc "Install a keyboard input handler."
...
asTree :: (Data (Annot phase), Typeable phase) => Syntax phase -> Tree (Syntax phase)
asTree = para Node

-- | Each constructor is a assigned a value of 1, plus
-- any recursive syntax it entails.
measureAstSize :: (Data (Annot phase), Typeable phase) => Syntax phase -> Int
