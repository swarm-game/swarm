...
terrainMap =
  M.fromList
    [ (StoneT, defaultTerrainDisplay '▒' (AWorld "rock"))
    , (DirtT, defaultTerrainDisplay '▒' (AWorld "dirt"))
    , (GrassT, defaultTerrainDisplay '▒' (AWorld "grass"))
    , (IceT, defaultTerrainDisplay ' ' (AWorld "ice"))
