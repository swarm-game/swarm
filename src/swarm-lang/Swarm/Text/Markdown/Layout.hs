...
class ToStream a p where
  -- | Convert to a stream of tokens, taking into account an optional
  --   line width.  If no line width is given, no extra Newline tokens
  --   will be inserted (though some may still be generated by
  --   e.g. code blocks).
