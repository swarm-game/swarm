...
| `author`       | `null`   | `string`                        | The author of the scenario.  Typically this is a person's name, but it can be any string. It is displayed under the scenario description in the new game menu.                                                                                                                                                                                                |
