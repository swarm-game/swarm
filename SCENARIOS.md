...
| `entities`     | `[]`     | list    | An optional list of custom entities, to be used in addition to the built-in entities.  See [Entities](#entities).                                                                                                                                                                                                                                               |
| `recipes`      | `[]`     | list    | An optional list of custom recipes, to be used in addition to the built-in recipes. They can refer to built-in entities as well as custom entities. See [Recipes](#recipes).                                                                                                                                                                                    |
...
| `objectives`   | `[]`     | list    | An optional list of objectives, aka winning conditions.  The player has to complete the objectives in sequence to win.  See [Objectives](#objectives).                                                                                                                                                                                                |
