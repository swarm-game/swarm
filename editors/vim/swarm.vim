...
syn keyword Builtins waypoint waypoints hastag tagmembers self parent base if inl inr case match force undefined default fail not format read chars split charat tochar unfoldarray unfoldarrayc arraysize indexarray key
